...
$filtroarea3='seguridad';
$resultado1='Muy competente';
$resultado2='Competente';
$resultado3='Necesita reforzamiento';
$resultado4='No satisfactorio';
$sql=("SELECT @s:=@s + 1 id,encabezado.response_id, encabezado.nomencuesta, encabezado.fecha, encabezado.encargado, encabezado.nombre, encabezado.puesto, encabezado.departamento,format(area1.nota,0) as nota1,format(area2.nota,0) as nota2, format(area3.nota, 0) as nota3, format(area1.nota+area2.nota+area3.nota,0) as notafinal,
if(area1.nota+area2.nota+area3.nota>=100,'Muy competente',if(area1.nota+area2.nota+area3.nota>= 90,'Competente',if(area1.nota+area2.nota+area3.nota>= 80,'Necesita mejorar','No satisfactorio'))) as resultado,encabezado.comentario
from
(select @s:=0) as s,
...
on q.id = qq.surveyid
where lower(q.name) LIKE '%".$filtroopera."%' and lower(qq.name) LIKE '%".$filtronombre."%')tempnombre
left JOIN
...
left JOIN
(select base.response_id, ((if(suma1.conteo is null , 0,suma1.conteo*65/conteototal.conteo))+(if(suma2.conteo is null , 0,suma2.conteo*55/conteototal.conteo))
+(if(suma3.conteo is null , 0,suma3.conteo*45/conteototal.conteo))+(if(suma4.conteo is null , 0,suma4.conteo*40/conteototal.conteo))) as nota
from
...
inner join mdl_questionnaire as q
on q.id = qq.surveyid
where lower(q.name) LIKE '%".$filtroopera."%' and lower(qq.name) LIKE '%".$filtroarea1."%'
...
inner join mdl_questionnaire as q
on q.id = qq.surveyid
where lower(q.name) Like '%".$filtroopera."%' and lower(qq.name) LIKE '%".$filtroarea1."%' and qrt.rankvalue=1
...
inner join mdl_questionnaire as q
on q.id = qq.surveyid
where lower(q.name) Like '%".$filtroopera."%' and lower(qq.name) LIKE '%".$filtroarea1."%' and qrt.rankvalue=2
...
inner join mdl_questionnaire as q
on q.id = qq.surveyid
where lower(q.name) Like '%".$filtroopera."%' and lower(qq.name) LIKE '%".$filtroarea1."%' and qrt.rankvalue=3
...
inner join mdl_questionnaire as q
on q.id = qq.surveyid
where lower(q.name) Like '%".$filtroopera."%' and lower(qq.name) LIKE '%".$filtroarea1."%' and qrt.rankvalue=4
...
left JOIN
(select base.response_id, ((if(suma1.conteo is null , 0,suma1.conteo*20/conteototal.conteo))+(if(suma2.conteo is null , 0,suma2.conteo*15/conteototal.conteo))+(if(suma3.conteo is null , 0,suma3.conteo*10/conteototal.conteo))+(if(suma4.conteo is null , 0,suma4.conteo*5/conteototal.conteo))) as nota
from
(select qr2.id as response_id
from
mdl_questionnaire_response as qr2
...
inner join mdl_questionnaire as q
on q.id = qq.surveyid
where lower(q.name) LIKE '%".$filtroopera."%' and lower(qq.name) LIKE '%".$filtroarea2."%'
group by qr2.id)base
LEFT join
(select qr.id as response_id,  count(qrt.rankvalue) as conteo
FROM mdl_questionnaire_response as qr
...
inner join mdl_questionnaire as q
on q.id = qq.surveyid
where lower(q.name) Like '%".$filtroopera."%' and lower(qq.name) LIKE '%".$filtroarea2."%' and qrt.rankvalue=1
group by qr.id) suma1
on base.response_id=suma1.response_id
LEFT join
(select qr.id as response_id,  count(qrt.rankvalue) as conteo
...
inner join mdl_questionnaire as q
on q.id = qq.surveyid
where lower(q.name) Like '%".$filtroopera."%' and lower(qq.name) LIKE '%".$filtroarea2."%' and qrt.rankvalue=2
group by qr.id) suma2
on base.response_id=suma2.response_id
LEFT join
(select qr.id as response_id,  count(qrt.rankvalue) as conteo
...
inner join mdl_questionnaire as q
on q.id = qq.surveyid
where lower(q.name) Like '%".$filtroopera."%' and lower(qq.name) LIKE '%".$filtroarea2."%' and qrt.rankvalue=3
group by qr.id) suma3
on base.response_id=suma3.response_id
LEFT join
(select qr.id as response_id,  count(qrt.rankvalue) as conteo
...
inner join mdl_questionnaire as q
on q.id = qq.surveyid
where lower(q.name) Like '%".$filtroopera."%' and lower(qq.name) LIKE '%".$filtroarea2."%' and qrt.rankvalue=4
group by qr.id) suma4
on base.response_id=suma4.response_id
inner join
(select qr.id as response_id, count(qrt.rankvalue) as conteo
...
inner join mdl_questionnaire as q
on q.id = qq.surveyid
where lower(q.name) LIKE '%".$filtroopera."%' and lower(qq.name) LIKE '%".$filtroarea3."%'
group by qr2.id)base
LEFT join
(select qr.id as response_id,  count(qrt.rankvalue) as conteo
FROM mdl_questionnaire_response as qr
...
inner join mdl_questionnaire as q
on q.id = qq.surveyid
where lower(q.name) Like '%".$filtroopera."%' and lower(qq.name) LIKE '%".$filtroarea3."%' and qrt.rankvalue=1
group by qr.id) suma1
on base.response_id=suma1.response_id
LEFT join
(select qr.id as response_id,  count(qrt.rankvalue) as conteo
...
inner join mdl_questionnaire as q
on q.id = qq.surveyid
where lower(q.name) Like '%".$filtroopera."%' and lower(qq.name) LIKE '%".$filtroarea3."%' and qrt.rankvalue=2
group by qr.id) suma2
on base.response_id=suma2.response_id
LEFT join
(select qr.id as response_id,  count(qrt.rankvalue) as conteo
...
inner join mdl_questionnaire as q
on q.id = qq.surveyid
where lower(q.name) Like '%".$filtroopera."%' and lower(qq.name) LIKE '%".$filtroarea3."%' and qrt.rankvalue=3
group by qr.id) suma3
on base.response_id=suma3.response_id
LEFT join
(select qr.id as response_id,  count(qrt.rankvalue) as conteo
...
inner join mdl_questionnaire as q
on q.id = qq.surveyid
where lower(q.name) Like '%".$filtroopera."%' and lower(qq.name) LIKE '%".$filtroarea3."%' and qrt.rankvalue=4
group by qr.id) suma4
on base.response_id=suma4.response_id
inner join
(select qr.id as response_id, count(qrt.rankvalue) as conteo
...
$sql3=("SELECT qqc.content as pregunta2,qrr.rankvalue as respuesta2
from mdl_questionnaire_response as qr
inner join mdl_questionnaire_response_rank as qrr
on qr.id=qrr.response_id
inner join mdl_questionnaire_quest_choice as qqc
...
inner join mdl_questionnaire_question qq
on qqc.question_id=qq.id
where qr.id=$response_id and qq.name like '%".$filtroarea3."%'");

$result3 = array();

if ($datas3 = $DB->get_records_sql($sql3)) {
    foreach($datas3 as $data3) {
        array_push($result3,(array)$data3);
        array_push($resultcompleto,(array)$data3);
    }
}



$areas=array_merge($result1,$result2,$result3);
...
if($bandera){
    echo $OUTPUT->render_from_template('local_report/respuesta2',$templatecontext);
