...
class uppresupuesto extends moodleform {
    ...
    function definition() {
        ...
        $response_nombre = optional_param('response_nombre', null, PARAM_FORMAT);
        ...
        $mform-> setDefault('nombre_presupuesto', $response_nombre);
        ...
        $registro->nombre = optional_param('nombre_presupuesto', '', PARAM_FORMAT);
