...
echo '<a style="margin-left: 415px" href="http://cursos.mayahonh.com/blocks/inicial/vistas/create_presupuesto.php" class="btn btn-primary">Crear nuevo presupuesto</a>';
$actualizateform = new QueryPresupuesto();
