...
$segmento = $actualizateform->display($response_id,$response_year,$response_month,$response_idp,$response_valor);
echo '<a href="http://cursos.mayahonh.com/blocks/inicial/vistas/index_ejecucion.php" class="btn btn-danger center-block">Cancelar</a>';
echo $OUTPUT->footer();
