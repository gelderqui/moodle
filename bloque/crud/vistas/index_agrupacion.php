...
echo '<a style="margin-left: 415px" href="http://cursos.mayahonh.com/blocks/inicial/vistas/create_agrupacion.php" class="btn btn-primary">Crear nueva agrupacion</a>';
...
echo '<a  style="margin-left: 100px" href="http://cursos.mayahonh.com/blocks/inicial/vistas/index_presupuesto.php" class="btn btn-info">Regresar</a>';
echo $OUTPUT->footer();
?>
