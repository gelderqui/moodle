...
echo '<a style="margin-left: 415px" href="http://cursos.mayahonh.com/blocks/inicial/vistas/create_ejecucion.php" class="btn btn-primary">Crear nueva ejecución</a>';
$actualizateform = new QueryEjecucion();
...
echo '<a style="margin-left: 10px" href="http://cursos.mayahonh.com/blocks/inicial/vistas/index_presupuesto.php" class="btn btn-info width: ">Regresar a presupuesto</a>';
echo $OUTPUT->footer();
?>
