...
If(notas.finalgrade<=0 or notas.finalgrade is null, if(completocriterio.num=completoecho.num2, '100','0'), notas.finalgrade ) as nota,
DATE_FORMAT(DATE_ADD(FROM_UNIXTIME(c.enddate, '%Y-%m-%d'), INTERVAL 1 HOUR),'%d/%m/%Y') AS fecha_finalizacion
from mdl_course c
